...
For the static pages, the whole page is blocked during revalidation, and fresh data is fetched and served. While I don't agree with this, as it is just a duplication of the expire behaviour, this is documented as intended in the comments in the code.
